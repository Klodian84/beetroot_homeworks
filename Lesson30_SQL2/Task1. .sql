...
SELECT e.first_name, e.last_name, e.department_id AS "Department Number", d.department_name AS "Department Name"
FROM employees e
JOIN departments d ON e.department_id = d.department_id;

-- 2. Display the first and last name, department, city,
...
-- 3. Display the first name, last name, department number,
-- and department name for employees in departments 80 or 40
SELECT e.first_name, e.last_name, e.department_id AS "Department Number", d.department_name AS "Department Name"
FROM employees e
JOIN departments d ON e.department_id = d.department_id
WHERE e.department_id IN (80, 40);

-- 4. Display all departments, including those without any employees
...
-- 6. Display the job title, full name (first and last name) of the employee,
-- and the difference between the maximum salary for the job and the salary of the employee
SELECT j.job_title, e.first_name || ' ' || e.last_name AS "Full Name",
...
-- 8. Display the full name (first and last name),
-- and salary of employees working in any department located in London
